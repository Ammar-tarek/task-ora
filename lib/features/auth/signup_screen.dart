    ...
    return Padding(
      ...
      child: Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 12),
          TextButton(
            onPressed: () => setState(() => _awaitingEmailConfirmation = false),
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          ...
          child: Row(children: [
            const Icon(Icons.admin_panel_settings_outlined, size: 18, color: AppColors.gold),
                    ...
                    GestureDetector(
                      ...
                      child: Text('Sign in instead →',
                        style: AppTextStyles.labelMd.copyWith(
                          color: AppColors.error, decoration: TextDecoration.underline,
                        )),
                    ),
                  ],
                ]),
