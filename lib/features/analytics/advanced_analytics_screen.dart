...
class _AdvancedAnalyticsScreenState extends State<AdvancedAnalyticsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _loading
          ...
          : _rows.isEmpty
          ? _empty()
          : TabBarView(controller: _tabs, children: [_overview(), _team()]),
    );
  }
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  if (high + med + low == 0)
                    Expanded(child: Container(color: AppColors.outlineVariant)),
                ],
              ),
            ),
          ],
  ...
  Widget _team() {
    ...
    for (final r in _rows) {
      for (final a in r.assignees) {
        byUser[a] = (byUser[a] ?? 0) + 1;
      }
    }
